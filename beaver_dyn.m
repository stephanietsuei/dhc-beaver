% Computes the state derivative of the DHC-2 Beaver. The model 
...
% Loads the matrices GM1, GM2, AM, and EM
%load('beaver.mat')
...
%massive_output = {deriv, ybvel, yuvw, ydl, yfp, ypow, yacc, Caero, Cprop, ...
%    FMaero, FMprop, Fgrav, Fwind, yatm, yad1, yad2, yad3};



%--------------------------
% All the nested functions!
%--------------------------
...
function [xdot, ybvel] = eqns(x, Ftot, Mtot, uwind, yatm, yhlp)
    ...
    function xdot = odes(x, Ftot, Mtot, yhlp, ybvel2)
        ...
        function dot1 = Vabdot(u)
            Vdot = (u(13)*u(19)*u(21) + u(14)*u(22) + u(15)*u(20)*u(21)) / m;
            adot = (-u(13)*u(20) + u(15)*u(19)) / (m*u(1)*u(21)) - ...
                   u(23)*(u(4)*u(19) + u(6)*u(20)) + u(5);
            bdot = (-u(13)*u(19)*u(22) + u(14)*u(21) - u(15)*u(20)*u(22)) / ...
        ...
        function dot4 = xyhdot(ybvel2, u)
            ...
            out11 = u1(30)*u1(27) + (u1(31)*u1(28) + u1(32)*u1(29))*u1(26);
            out12 = u1(31)*u1(29) - u1(32)*u1(28);
            
            u2 = [u; out11; out12];
            xedot = u2(30)*u2(25) - u2(31)*u2(24);
            yedot = u2(30)*u2(24) + u2(31)*u2(25);
            hdot = u1(30)*u1(26) - (u1(31)*u1(28) + u1(32)*u1(29))*u1(27);
...
function [yfp, yuvw, yacc] = addlouts(x, xdot, yhlp, Ftot, Fgrav)
    ...
    function yuvw = uvwdot(x, xdot, yhlp)
        ...
        udot = u(6)*u(1)*u(3) - u(5)*(u(7)*u(2)*u(3) + u(8)*u(1)*u(4));
        vdot = u(6)*u(4) + u(5)*u(3)*u(8);
        wdot = u(6)*u(2)*u(3) + u(5)*(u(7)*u(1)*u(3) - u(8)*u(2)*u(4));
